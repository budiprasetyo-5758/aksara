...
export function ChatSidebar() {
  ...
  return (
    <aside className="w-[260px] min-w-[260px] bg-sidebar-bg text-white flex flex-col h-screen">
      {/* Logo */}
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-teal-400 to-cyan-600 flex items-center justify-center text-sm font-bold">
            AN
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium truncate">Dr. Aris Nugraha</p>
            <p className="text-xs text-gray-400 truncate">Resident - Cardiology</p>
          </div>
